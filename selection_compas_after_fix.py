...
class CompasDataset(StandardDataset):
    ...
    def __init__(self, label_name='two_year_recid', favorable_classes=[0],
        ...
        # _,df_pos_test = train_test_split(df_pos,test_size=1149,random_state= 1)
        
        # df_neg = df.loc[df['two_year_recid']==1,:]

        # df = df_neg.append(df_pos_test)
        ...
        _,df_neg_priv_test =train_test_split(df_neg_priv,test_size=500,random_state=10)
        _,df_neg_unpriv_test =train_test_split(df_neg_unpriv,test_size=920,random_state=10)
...
#         _,df_neg_test = train_test_split(df_neg,test_size=1800,random_state= 8)
        ...
        _,df_pos_priv_test =train_test_split(df_pos_priv,test_size=680,random_state=10)
        _,df_pos_unpriv_test =train_test_split(df_pos_unpriv,test_size=900,random_state=10)
